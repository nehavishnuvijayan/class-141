...
# Webdriver
browser = webdriver.Chrome("C:/Users/User/OneDrive/Documents/python folder/chromedriver-win64/chromedriver.exe")
...
# Convert to CSV
planets_df.to_csv("scarped_data",index=True,index_label="id")
